...
return [
    ...
    'Only files with these MIME types are allowed: {mimeTypes}.' => ' - только файлы со следующими MIME-типами: {mimeTypes}.',
    'Only files with these extensions are allowed: {extensions}.' => ' - только файлы со следующими расширениями: {extensions}.',
...
//    'Powered by {yii}' => 'Работает на {yii}',
    ...
    'The combination {values} of {attributes} has already been taken.' => ' - такая комбинация параметров {attributes} уже существует.',
    'The file "{file}" is not an image.' => ' - файл «{file}» не является изображением.',
    'The file "{file}" is too big. Its size cannot exceed {formattedLimit}.' => ' - размер файла «{file}» превышает {formattedLimit}.',
    'The file "{file}" is too small. Its size cannot be smaller than {formattedLimit}.' => ' - размер файла «{file}» не может быть менее {formattedLimit}.',
    ...
    '{attribute} "{value}" has already been taken.' => ' - запись с таким значение уже существует.',
    '{attribute} cannot be blank.' => ' - не может быть пустым.',
    '{attribute} contains wrong subnet mask.' => 'Значение «{attribute}» содержит неверную маску подсети.',
    '{attribute} is invalid.' => ' - неверно.',
    '{attribute} is not a valid URL.' => ' - не является правильным URL.',
    '{attribute} is not a valid email address.' => ' - не является правильным email адресом.',
    '{attribute} is not in the allowed range.' => ' - не входит в список разрешенных диапазонов адресов.',
    '{attribute} must be "{requiredValue}".' => ' - не совпадает с «{requiredValue}».',
    '{attribute} must be a number.' => ' - должно быть числом.',
    '{attribute} must be a string.' => ' - должно быть строкой.',
    ...
    '{attribute} must be an integer.' => ' - должно быть целым числом.',
    '{attribute} must be either "{true}" or "{false}".' => ' - должно быть равно «{true}» или «{false}».',
    '{attribute} must be equal to "{compareValueOrAttribute}".' => ' - должно быть равно «{compareValueOrAttribute}».',
    '{attribute} must be greater than "{compareValueOrAttribute}".' => ' - должно быть больше значения «{compareValueOrAttribute}».',
    '{attribute} must be greater than or equal to "{compareValueOrAttribute}".' => ' - должно быть больше или равно значения «{compareValueOrAttribute}».',
    '{attribute} must be less than "{compareValueOrAttribute}".' => ' - должно быть меньше значения «{compareValueOrAttribute}».',
    '{attribute} must be less than or equal to "{compareValueOrAttribute}".' => ' - должно быть меньше или равно значения «{compareValueOrAttribute}».',
    '{attribute} must be no greater than {max}.' => ' -  не должно превышать {max}.',
    '{attribute} must be no less than {min}.' => ' - должно быть не меньше {min}.',
    ...
    '{attribute} must not be equal to "{compareValueOrAttribute}".' => ' - не должно быть равно «{compareValueOrAttribute}».',
    '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.' => ' - минимум {min, number} {min, plural, one{символ} few{символа} many{символов} other{символа}}.',
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => ' - максимум {max, number} {max, plural, one{символ} few{символа} many{символов} other{символа}}.',
    '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.' => ' - должно содержать {length, number} {length, plural, one{символ} few{символа} many{символов} other{символа}}.',
